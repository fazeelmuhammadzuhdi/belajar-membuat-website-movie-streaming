                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" placeholder="e.g Guardian of The Galaxy" value="{{ old('title') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('trailer') is-invalid @enderror" id="trailer"
                                name="trailer" placeholder="Video url" value="{{ old('trailer') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('movie') is-invalid @enderror" id="movie"
                                name="movie" placeholder="Video url" value="{{ old('movie') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('casts') is-invalid @enderror" id="casts"
                                name="casts" placeholder="Jackie Chan" value="{{ old('casts') }}">
                            @error('casts')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('about') is-invalid @enderror" id="about"
                                name="about" placeholder="Awesome Movie" value="{{ old('about') }}">
                            @error('about')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
